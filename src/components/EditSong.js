...
export default function EditSong(props){
    ...
    useEffect(function () {
        ...
        axios.get('https://juice-archive-b646t.ondigitalocean.app/api/songs/' + id)
    ...
    function saveSong(event){
        ...
        if(song && !isLoading){
            ...
            axios.put("https://juice-archive-b646t.ondigitalocean.app/api/songs/" + id, {
                title: song.title,
                artist: song.artist,
                    ...
                    <>
                            <div className="shadow overflow-hidden sm:rounded-md">
                                ...
                                <div className="px-4 py-3 bg-gray-800 text-right sm:px-6 space-x-2">
                                    ...
                                    <button onClick={saveSong} type="submit"
