...
function App() {
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr className="bg-black">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium inline-flex space-x-2 bg-black">
                        <button onClick={() => queueSong(currentSong)} type="button"
  ...
  return (
    ...
    <div class="bg-white text-center m-20 rounded-2xl pt-3 px-2">
        ...
        <audio className="mx-auto w-full" src={'https://kody.sfo3.cdn.digitaloceanspaces.com/' + currentSong} controls>
  ...
  return (
    <tr class="bg-white">
      ...
      <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium inline-flex space-x-2">
        <button onClick={() => props.queueSong(props.songName)} type="button" class="inline-flex items-center p-1.5 border border-transparent rounded-full shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
          </svg>
        </button>
        <button className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" onClick={() => props.playSong(props.songName)}>Play</button>
      </td>
    </tr>
  );
